- [简介](#简介)
  - [MQ服务相关概念](#mq服务相关概念)
  - [MQ服务的具体使用方法](#mq服务的具体使用方法)
  - [MQ服务快速启动](#mq服务快速启动)
    - [安装rabbitmq-server](#安装rabbitmq-server)
    - [启动](#启动)
    - [使用docker容器启动](#使用docker容器启动)
  - [配置文件配置MQ服务](#配置文件配置mq服务)
  - [jsonrpc接口](#jsonrpc接口)
    - [备注](#备注)
  - [SDK对应的API接口](#sdk对应的api接口)
    - [消息消费者Demo](#消息消费者demo)
  - [完整操作流程](#完整操作流程)
  - [提供的可订阅事件路由键](#提供的可订阅事件路由键)
    - [订阅规则](#订阅规则)
  - [异常情况处理](#异常情况处理)
  - [权限控制](#权限控制)
  - [注意事项](#注意事项)
...
目前Log事件中的data字段编码方式在平台版本flato1.0.3及以后为**hex**，flato1.0.3以前为**base64**，按照相应方式进行解码，即可得到原始的字节数组