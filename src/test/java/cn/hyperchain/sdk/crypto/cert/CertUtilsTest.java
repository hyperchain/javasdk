...
public class CertUtilsTest extends TestCase {
    ...
    public void testGetCertFromPFXFile() throws Exception {
        ...
        System.out.println("OriPub:" + ByteUtil.toHex(cert.getPublicKey().getEncoded()));
        System.out.println("OriBase64Pub-ori:" + Base64.encodeBase64String(cert.getPublicKey().getEncoded()));
        System.out.println("Pub:" + ByteUtil.toHex(cert.getPublicKey().getEncoded()).substring(46,176));
    ...
    public void testGetPrivFromPFXFile() throws IOException, UnrecoverableEntryException, CertificateException, NoSuchAlgorithmException, KeyStoreException, NoSuchProviderException, InvalidKeySpecException {
        String path = "/Users/ziyang/Downloads/certificate.pfx";
        String password = "123456";
